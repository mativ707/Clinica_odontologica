                            ...
                            <div class="card shadow-lg border-0 mt-5">
                                ...
                                <div class="card-body">
                                    <form action="SvTurno" method="POST">
                                        ...
                                        <h1 class="mt-4">Odontólogo</h1>
                                        <ol class="breadcrumb mb-4">
                                            <li class="breadcrumb-item active">Seleccione un odontólogo para el turno</li>
                                        </ol>
                                        ...
                                        <ol class="breadcrumb mb-4">
                                            <li class="breadcrumb-item active">Seleccione un paciente para el turno</li>
                                        </ol>
                                        <div class="card mb-2 mt-4">
                                            <div class="card-header">
                                                <i class="fas fa-table me-1"></i>
