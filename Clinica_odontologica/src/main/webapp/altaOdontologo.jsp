                        ...
                        <div class="register-container">
                            <div class="row justify-content-center">
                                <div class="card shadow-lg border-0 mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light">Registrar Odontológo</h3></div>
                                    <div class="card-body">
                                        <form action="SvOdontologo" method="POST">
                                            <div class="row mb-3">
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputDNI" name="dni" type="text" placeholder="Ingrese DNI del Odontólogo" />
                                                        <label for="inputDNI">DNI</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" name="nombre" type="text" placeholder="Ingrese nombre del Odontólogo" />
                                                        <label for="inputFirstName">Nombre</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" name="apellido" type="text" placeholder="Ingrese apellido del Odontólogo" />
                                                        <label for="inputLastName">Apellido</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mt-3">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputTel" name="tel" type="text" placeholder="Ingrese teléfono del Odontólogo" />
                                                        <label for="inputTel">Teléfono</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mt-3">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputDir" name="direccion" type="text" placeholder="Ingrese dirección del Odontólogo" />
                                                        <label for="inputDir">Dirección</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mt-3">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputFecha" name="fechaNac" type="date" placeholder="Ingrese fecha de nacimiento del Odontólogo" />
                                                        <label for="inputFecha">Fecha de Nacimiento</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mt-3">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputEspec" name="especialidad" type="text" placeholder="Ingrese especialidad del odontólogo" />
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    <div class="form-check">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" id="miercoles" name="diasLaborales" value="Miércoles">
                                    ...
                                    <div class="mt-4 mb-3">
                                        <div class="d-grid"><button class="btn btn-primary btn-block" type="submit">Registrar Odontólogo</button></div>
                                    </div>
                                    </form>
                                </div>
                            </div>
